...
abstract class Unexpected implements TransactionFailure {
...
class _$TimeLimitExceeded implements TimeLimitExceeded {
  ...
  @override
  String toString() {
    return 'TransactionFailure.timeLimitExceeded()';
  }
...
abstract class TimeLimitExceeded implements TransactionFailure {
