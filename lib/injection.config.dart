...
import 'aplication/coin_list_bloc/coin_list_bloc.dart' as _i25;
import 'aplication/contact/contact_form_bloc/contact_form_bloc.dart' as _i26;
import 'aplication/contact/contact_list_bloc/contact_list_bloc.dart' as _i27;
...
import 'aplication/transaction_list_bloc/transaction_list_bloc.dart' as _i20;
import 'aplication/wallet/wallet_form_bloc/wallet_form_bloc.dart' as _i21;
import 'aplication/wallet/wallet_watch_bloc/wallet_watch_bloc.dart' as _i22;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i20.TransactionListBloc>(
      () => _i20.TransactionListBloc(get<_i13.ITransactionRepository>()));
  gh.factory<_i21.WalletFormBloc>(
      () => _i21.WalletFormBloc(get<_i15.IWalletRepository>()));
  gh.factory<_i22.WalletWatchBloc>(
      () => _i22.WalletWatchBloc(get<_i15.IWalletRepository>()));
  gh.factory<_i23.AuthBloc>(() => _i23.AuthBloc(get<_i7.IAuthFacade>()));
  gh.factory<_i24.ChangePasswordFormBloc>(
      () => _i24.ChangePasswordFormBloc(get<_i7.IAuthFacade>()));
  gh.factory<_i25.CoinListBloc>(
      () => _i25.CoinListBloc(get<_i9.ICoinRepository>()));
  gh.factory<_i26.ContactFormBloc>(
      () => _i26.ContactFormBloc(get<_i11.IContactRepository>()));
  gh.factory<_i27.ContactListBloc>(
      () => _i27.ContactListBloc(get<_i11.IContactRepository>()));
  return get;
}
